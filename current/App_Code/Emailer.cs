...
{
    private string host = "mail.kenneronline.com";
    ...
    public emailer()
    {
        fromAddress = "\"iVote System\" <automailer@csc354.kenneronline.com>";
        host = "mail.csc354.kenneronline.com";
        userName = "automailer@csc354.kenneronline.com";
        userPass = "password";
        portNumber = 587;
        enableSSL = false;
