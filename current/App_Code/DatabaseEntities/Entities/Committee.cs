...
namespace DatabaseEntities
{
    ...
    public class Committee
    {
        ...
        /// <summary>
        /// Whether or not faculty MUST be in the bargaining unit to
        /// be eligible for this committee.
        /// </summary>
        public virtual bool BargainingRequired { get; set; }

        /// <summary>
        /// Whether or not faculty must be tenured to be eligible for
        /// this committee.
        /// </summary>
