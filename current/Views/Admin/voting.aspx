<%@ Page Title="" Language="C#" MasterPageFile="../../Site.master" AutoEventWireup="true" CodeFile="voting.aspx.cs" Inherits="Admin_voting" %>
...
<asp:Label ID="lblForm" runat="server">
    ...
    <div id="bodyCopy">
        ...
        Faculty members will be able to vote for the canidates they wish to vote for.
    </div>
    <div id="functions">
        <div class="column">
        ...
        <div class="column">
            <b>Election Management</b><br />
              There are no current tasks to be done during this phase.
            <br />
        </div>
        <div class="column">
