...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        <b>Please sign in using your username and password.</b>
    </p>
   <asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false">
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="login" style="background-color: #D3CDD0">
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password" 
                             ...
                             ValidationGroup="LoginUserValidationGroup">*</asp:RequiredFieldValidator>
                        <br />
                        <asp:Button ID="Button1" runat="server" CommandName="Login" Width="100" Text="Log In" ValidationGroup="LoginUserValidationGroup"/>
